...
export interface PriorityOption {
  ...
  label: string;
  icon: string;
  color: 'error' | 'warning' | 'neutral' | 'primary' | 'success' | 'info';
  ringClass: string;
  textClass: string;
}
...
export const PRIORITY_OPTIONS: PriorityOption[] = [
  ...
  { value: 1, label: 'Snack',    icon: 'i-lucide-cookie',    color: 'success', ringClass: 'ring-emerald-500/60', textClass: 'text-emerald-400' },
];
